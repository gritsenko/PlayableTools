 ...
 */const it=globalThis;let oe=class extends ie{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=_s(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return te}};oe._$litElement$=!0,oe.finalized=!0,it.litElementHydrateSupport?.({LitElement:oe});const xs=it.litElementPolyfillSupport;xs?.({LitElement:oe});(it.litElementVersions??=[]).push("4.2.1");class Ss{update(e){e.title&&(document.title=e.title);let t=document.querySelector('meta[name="description"]');t||(t=document.createElement("meta"),t.setAttribute("name","description"),document.head.appendChild(t)),t.setAttribute("content",e.description||"")}}const Ge=new Ss;var Ps=Object.defineProperty,As=Object.getOwnPropertyDescriptor,at=(n,e,t,s)=>{for(var r=s>1?void 0:s?As(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&Ps(e,t,r),r};let Oe=class extends oe{constructor(){super(...arguments),this.currentPath="",this.handleNavigation=()=>{const n=window.location.hash;let e=n?n.substring(1):"";e.startsWith("/")||(e="/"+e),this.currentPath=e,this.requestUpdate()}}connectedCallback(){super.connectedCallback(),window.addEventListener("hashchange",this.handleNavigation),this.handleNavigation()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this.handleNavigation)}createRenderRoot(){return this}render(){for(const[n,e]of mr.entries()){const t=new RegExp("^"+n.replace(/:[^\s/]+/g,"([\\w-]+)")+"$"),s=this.currentPath.match(t);if(s){e.metadata?Ge.update(e.metadata):Ge.update({title:"PlayableTools"});const r=s.slice(1),i=new e.component;return i.routeParams=r,this.renderContentWithLayout(()=>A`<div>${i}</div>`)}}return Ge.update({title:"Page Not Found"}),this.renderContentWithLayout(()=>A`<h1>404 Not Found</h1>`)}renderContentWithLayout(n){if(!this.defaultLayout)return n();const e=new this.defaultLayout;return e.body=n(),A`
    ...
    `}};ke([V({type:Boolean})],ce.prototype,"open",2);ke([V({type:String})],ce.prototype,"src",2);ke([V({type:String})],ce.prototype,"alt",2);ke([V({type:String})],ce.prototype,"thumbWidth",2);ce=ke([H("image-popup")],ce);var Os=Object.getOwnPropertyDescriptor,Ms=(n,e,t,s)=>{for(var r=s>1?void 0:s?Os(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=a(r)||r);return r};let We=class{async convertFilesToBase64(n,e){const t=[];for(let s=0;s<n.length;s++){const r=n[s],i=r.type||"application/octet-stream",a=await this.fileToDataUrl(r),o=a.split(",")[1]||"";t.push({file:r,name:r.name,mimeType:i,dataUrl:a,originalSize:r.size,base64Size:o.length}),e&&e(Math.round((s+1)/n.length*100))}return t}fileToDataUrl(n){return new Promise((e,t)=>{const s=new FileReader;s.onload=()=>e(s.result),s.onerror=t,s.readAsDataURL(n)})}};We=Ms([lr(ae.Singleton)],We);var Rs=Object.defineProperty,Is=Object.getOwnPropertyDescriptor,br=(n,e,t,s)=>{for(var r=s>1?void 0:s?Is(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&Rs(e,t,r),r};let Ve=class extends L{constructor(){super(...arguments),this.dragActive=!1,this.files=[],this.progress=0,this.results=[],this.processing=!1,this.copiedIndex=null,this._onDragOver=e=>{e.preventDefault(),this.dragActive=!0,this.requestUpdate()},this._onDragLeave=e=>{e.preventDefault(),this.dragActive=!1,this.requestUpdate()},this._onDrop=e=>{e.preventDefault(),this.dragActive=!1,e.dataTransfer?.files?.length&&this._handleFiles(e.dataTransfer.files)},this._onFileChange=e=>{const t=e.target;t.files?.length&&this._handleFiles(t.files)}}_downloadDataUrl(e,t,s){e.preventDefault();const r=window.open();r&&(r.document.write("<pre>"+this._escapeHtml(t)+"</pre>"),r.document.title=s+" (Base64)")}_escapeHtml(e){return e.replace(/[&<>"']/g,function(t){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[t]})}async _handleFiles(e){this.files=Array.from(e),this.progress=0,this.processing=!0,this.results=[],this.requestUpdate(),this.results=await this.base64Service.convertFilesToBase64(this.files,t=>{this.progress=t,this.requestUpdate()}),this.processing=!1,this.requestUpdate()}async _copyToClipboard(e,t){try{await navigator.clipboard.writeText(e),this.copiedIndex=t,this.requestUpdate(),setTimeout(()=>{this.copiedIndex=null,this.requestUpdate()},3e3)}catch{}}_selectDataUrl(e){const t=e.currentTarget;if(!t)return;const s=document.createRange();s.selectNodeContents(t);const r=window.getSelection();r?.removeAllRanges(),r?.addRange(s)}render(){return A`
      ...
      ${this.results.length>0?A`
          ...
          `:null}
    `}};br([cr(We)],Ve.prototype,"base64Service",2);Ve=br([H("base64-page"),he("/base64",{title:"Base64 Converter",description:"A simple tool to convert text to Base64 and vice versa."})],Ve);var Ds=Object.getOwnPropertyDescriptor,Us=(n,e,t,s)=>{for(var r=s>1?void 0:s?Ds(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=a(r)||r);return r};let Wt=class extends L{render(){return A`
    ...
    `}};Wt=Us([H("compress-assets-page"),he("/compress-assets")],Wt);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ke extends Ls{constructor(e){if(super(e),this.it=I,e.type!==zs.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===I||e==null)return this._t=void 0,this.it=e;if(e===te)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ke.directiveName="unsafeHTML",Ke.resultType=1;const Hs=js(Ke);function ot(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var se=ot();function yr(n){se=n}var be={exec:()=>null};function T(n,e=""){let t=typeof n=="string"?n:n.source,s={replace:(r,i)=>{let a=typeof i=="string"?i:i.source;return a=a.replace(j.caret,"$1"),t=t.replace(r,a),s},getRegex:()=>new RegExp(t,e)};return s}var j={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:n=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i")},Bs=/^(?:[ \t]*(?:\n|$))+/,Fs=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Ns=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,$e=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,qs=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,lt=/(?:[*+-]|\d{1,9}[.)])/,wr=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,vr=T(wr).replace(/bull/g,lt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Gs=T(wr).replace(/bull/g,lt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),ct=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Zs=/^[^\n]+/,ht=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Ws=T(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",ht).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Vs=T(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,lt).getRegex(),ze="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",ut=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Ks=T("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",ut).replace("tag",ze).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),kr=T(ct).replace("hr",$e).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ze).getRegex(),Ys=T(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",kr).getRegex(),pt={blockquote:Ys,code:Fs,def:Ws,fences:Ns,heading:qs,hr:$e,html:Ks,lheading:vr,list:Vs,newline:Bs,paragraph:kr,table:be,text:Zs},Vt=T("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",$e).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ze).getRegex(),Qs={...pt,lheading:Gs,table:Vt,paragraph:T(ct).replace("hr",$e).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Vt).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ze).getRegex()},Xs={...pt,html:T(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",ut).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:be,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:T(ct).replace("hr",$e).replace("heading",` *#{1,6} *[^
]`).replace("lheading",vr).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Js=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,en=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,$r=/^( {2,}|\\)\n(?!\s*$)/,tn=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,je=/[\p{P}\p{S}]/u,dt=/[\s\p{P}\p{S}]/u,_r=/[^\s\p{P}\p{S}]/u,rn=T(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,dt).getRegex(),xr=/(?!~)[\p{P}\p{S}]/u,sn=/(?!~)[\s\p{P}\p{S}]/u,nn=/(?:[^\s\p{P}\p{S}]|~)/u,an=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,Sr=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,on=T(Sr,"u").replace(/punct/g,je).getRegex(),ln=T(Sr,"u").replace(/punct/g,xr).getRegex(),Pr="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",cn=T(Pr,"gu").replace(/notPunctSpace/g,_r).replace(/punctSpace/g,dt).replace(/punct/g,je).getRegex(),hn=T(Pr,"gu").replace(/notPunctSpace/g,nn).replace(/punctSpace/g,sn).replace(/punct/g,xr).getRegex(),un=T("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,_r).replace(/punctSpace/g,dt).replace(/punct/g,je).getRegex(),pn=T(/\\(punct)/,"gu").replace(/punct/g,je).getRegex(),dn=T(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),fn=T(ut).replace("(?:-->|$)","-->").getRegex(),gn=T("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",fn).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Me=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,mn=T(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Me).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Ar=T(/^!?\[(label)\]\[(ref)\]/).replace("label",Me).replace("ref",ht).getRegex(),Tr=T(/^!?\[(ref)\](?:\[\])?/).replace("ref",ht).getRegex(),bn=T("reflink|nolink(?!\\()","g").replace("reflink",Ar).replace("nolink",Tr).getRegex(),ft={_backpedal:be,anyPunctuation:pn,autolink:dn,blockSkip:an,br:$r,code:en,del:be,emStrongLDelim:on,emStrongRDelimAst:cn,emStrongRDelimUnd:un,escape:Js,link:mn,nolink:Tr,punctuation:rn,reflink:Ar,reflinkSearch:bn,tag:gn,text:tn,url:be},yn={...ft,link:T(/^!?\[(label)\]\((.*?)\)/).replace("label",Me).getRegex(),reflink:T(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Me).getRegex()},Ye={...ft,emStrongRDelimAst:hn,emStrongLDelim:ln,url:T(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},wn={...Ye,br:T($r).replace("{2,}","*").getRegex(),text:T(Ye.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Pe={normal:pt,gfm:Qs,pedantic:Xs},fe={normal:ft,gfm:Ye,breaks:wn,pedantic:yn},vn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Kt=n=>vn[n];function q(n,e){if(e){if(j.escapeTest.test(n))return n.replace(j.escapeReplace,Kt)}else if(j.escapeTestNoEncode.test(n))return n.replace(j.escapeReplaceNoEncode,Kt);return n}function Yt(n){try{n=encodeURI(n).replace(j.percentDecode,"%")}catch{return null}return n}function Qt(n,e){let t=n.replace(j.findPipe,(i,a,o)=>{let h=!1,p=a;for(;--p>=0&&o[p]==="\\";)h=!h;return h?"|":" |"}),s=t.split(j.splitPipe),r=0;if(s[0].trim()||s.shift(),s.length>0&&!s.at(-1)?.trim()&&s.pop(),e)if(s.length>e)s.splice(e);else for(;s.length<e;)s.push("");for(;r<s.length;r++)s[r]=s[r].trim().replace(j.slashPipe,"|");return s}function ge(n,e,t){let s=n.length;if(s===0)return"";let r=0;for(;r<s&&n.charAt(s-r-1)===e;)r++;return n.slice(0,s-r)}function kn(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let s=0;s<n.length;s++)if(n[s]==="\\")s++;else if(n[s]===e[0])t++;else if(n[s]===e[1]&&(t--,t<0))return s;return t>0?-2:-1}function Xt(n,e,t,s,r){let i=e.href,a=e.title||null,o=n[1].replace(r.other.outputLinkReplace,"$1");s.state.inLink=!0;let h={type:n[0].charAt(0)==="!"?"image":"link",raw:t,href:i,title:a,text:o,tokens:s.inlineTokens(o)};return s.state.inLink=!1,h}function $n(n,e,t){let s=n.match(t.other.indentCodeCompensation);if(s===null)return e;let r=s[1];return e.split(`
...
`;var Sn=Object.getOwnPropertyDescriptor,Pn=(n,e,t,s)=>{for(var r=s>1?void 0:s?Sn(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=a(r)||r);return r};let Jt=class extends L{constructor(){super(...arguments),this.markdownHtml=""}connectedCallback(){super.connectedCallback();const n=C.parse(xn);typeof n=="string"&&(this.markdownHtml=n),this.requestUpdate()}render(){return A`
      <div class="cta-sdk-info">
        <div>${Hs(this.markdownHtml)}</div>
      </div>
    `}};Jt=Pn([H("cta-sdk-page"),he("/cta-sdk",{title:"CTA SDK Documentation",description:"Documentation for the CTA SDK, providing guidance on how to integrate and use the SDK in your playable ads."})],Jt);var An=Object.getOwnPropertyDescriptor,Tn=(n,e,t,s)=>{for(var r=s>1?void 0:s?An(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=a(r)||r);return r};let er=class extends L{render(){return A`
...
For best results, please use Chrome 86+, Edge 86+, or another browser that supports the File System Access API.`),alert(`Publishing failed: ${t}`),this.isPublishing=!1,this.publishProgress=0,this.requestUpdate()}}_formatElapsed(e){const t=Math.floor(e/1e3),s=Math.floor(t/60),r=t%60;return s>0?`${s}m ${r}s`:`${r}s`}_readFileContent(e){return new Promise((t,s)=>{const r=new FileReader;r.onload=i=>{const a=i.target?.result;typeof a=="string"?t(a):s(new Error("Failed to read file as text"))},r.onerror=()=>s(new Error("Failed to read file")),r.readAsText(e)})}loadFromLocalStorage(){this.playableTitle=localStorage.getItem(this.STORAGE_KEYS.playableTitle)||"",this.googlePlayUrl=localStorage.getItem(this.STORAGE_KEYS.googlePlayUrl)||"",this.appStoreUrl=localStorage.getItem(this.STORAGE_KEYS.appStoreUrl)||"",this.customSuffix=localStorage.getItem(this.STORAGE_KEYS.customSuffix)||"EN";const e=localStorage.getItem(this.STORAGE_KEYS.selectedPlatforms);if(e)try{const t=JSON.parse(e);Array.isArray(t)&&(this.selectedPlatforms=t)}catch{}this.requestUpdate()}saveToLocalStorage(){localStorage.setItem(this.STORAGE_KEYS.playableTitle,this.playableTitle),localStorage.setItem(this.STORAGE_KEYS.googlePlayUrl,this.googlePlayUrl),localStorage.setItem(this.STORAGE_KEYS.appStoreUrl,this.appStoreUrl),localStorage.setItem(this.STORAGE_KEYS.customSuffix,this.customSuffix),localStorage.setItem(this.STORAGE_KEYS.selectedPlatforms,JSON.stringify(this.selectedPlatforms))}updateField(e,t){switch(e){case"playableTitle":this.playableTitle=t;break;case"googlePlayUrl":this.googlePlayUrl=t;break;case"appStoreUrl":this.appStoreUrl=t;break;case"customSuffix":this.customSuffix=t;break}this.saveToLocalStorage(),this.requestUpdate()}}jn([cr(Je)],Er.prototype,"playablePublishService");customElements.define("playable-publisher",Er);var Ln=Object.getOwnPropertyDescriptor,Hn=(n,e,t,s)=>{for(var r=s>1?void 0:s?Ln(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=a(r)||r);return r};let rr=class extends L{render(){return A`
    ...
    `}};rr=Hn([H("publish-page"),he("/publish",{title:"Publish Playable Ads",description:"Publish your playable ads to multiple ad networks with ease. This tool streamlines the process of deploying your ads."})],rr);var Bn=Object.getOwnPropertyDescriptor,Fn=(n,e,t,s)=>{for(var r=s>1?void 0:s?Bn(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=a(r)||r);return r};let sr=class extends L{render(){return A`
 ...
 */const Nn=n=>n??I;var qn=Object.getOwnPropertyDescriptor,Gn=(n,e,t,s)=>{for(var r=s>1?void 0:s?qn(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=a(r)||r);return r};let nr=class extends L{constructor(){super(...arguments),this.menuItems=[{label:"Home",path:"/",disabled:!1},{label:"CTA SDK",path:"/cta-sdk",disabled:!1},{label:"Publish",path:"/publish",disabled:!1},{label:"Validate",path:"/validate",disabled:!1},{label:"Compress assets",path:"/compress-assets",disabled:!1},{label:"Base64 Converter",path:"/base64",disabled:!1},{label:"FAQ",path:"/faq",disabled:!0}],this.handleHashChange=()=>{this.requestUpdate()}}get currentPath(){let n=window.location.hash?window.location.hash.substring(1):"";return n.startsWith("/")||(n="/"+n),n}connectedCallback(){super.connectedCallback(),window.addEventListener("hashchange",this.handleHashChange)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this.handleHashChange)}render(){return A`
    ...
    `}};nr=Gn([H("nav-menu")],nr);var Zn=Object.getOwnPropertyDescriptor,Wn=(n,e,t,s)=>{for(var r=s>1?void 0:s?Zn(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=a(r)||r);return r};let ir=class extends L{render(){return A`
      <a href="/" class="site-logo-link">
        <img
          src="${Cr.buildFetchUrl("","small-logo.jpg")}"
          alt="Logo"
          class="site-logo-img"
        />
    ...
    `}};mt([V({attribute:!1,type:Object})],ve.prototype,"body",2);mt([V({type:Boolean})],ve.prototype,"sidebarOpen",2);ve=mt([H("main-layout")],ve);var Yn=Object.getOwnPropertyDescriptor,Qn=(n,e,t,s)=>{for(var r=s>1?void 0:s?Yn(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=a(r)||r);return r};let ar=class extends L{render(){return A`
      <router-outlet .defaultLayout="${ve}"></router-outlet>
    `}};ar=Qn([H("app-root")],ar);export{jt as c,ei as g};
