 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function en(n){return Qe({...n,state:!0,attribute:!1})}var Rt=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Is(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var Mt={};/*! *****************************************************************************
 ...
 */const Ss=n=>n??M;var Ps=Object.getOwnPropertyDescriptor,As=(n,e,t,s)=>{for(var r=s>1?void 0:s?Ps(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=a(r)||r);return r};let Kt=class extends q{constructor(){super(...arguments),this.menuItems=[{label:"Home",path:"/",disabled:!1},{label:"CTA SDK",path:"/cta-sdk",disabled:!1},{label:"Publish",path:"/publish",disabled:!1},{label:"Validate",path:"/validate",disabled:!1},{label:"Compress assets",path:"/weather",disabled:!0},{label:"FAQ",path:"/faq",disabled:!0}],this.handleHashChange=()=>{this.requestUpdate()}}get currentPath(){let n=window.location.hash?window.location.hash.substring(1):"";return n.startsWith("/")||(n="/"+n),n}connectedCallback(){super.connectedCallback(),window.addEventListener("hashchange",this.handleHashChange)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this.handleHashChange)}render(){return I`
    ...
    `}};wr([Qe({attribute:!1,type:Object})],Ce.prototype,"body",2);Ce=wr([W("main-layout")],Ce);var Cs=Object.getOwnPropertyDescriptor,Os=(n,e,t,s)=>{for(var r=s>1?void 0:s?Cs(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=a(r)||r);return r};let Xt=class extends q{render(){return I`
      <router-outlet .defaultLayout="${Ce}"></router-outlet>
    `}};Xt=Os([W("app-root")],Xt);export{Rt as c,Is as g};
