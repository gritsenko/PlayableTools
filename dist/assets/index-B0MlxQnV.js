...
`,1)[0],Y;if(k=le,this.options.pedantic?(k=k.replace(this.rules.other.listReplaceNesting,"  "),Y=k):Y=k.replace(this.rules.other.tabCharGlobal,"    "),ye.test(k)||we.test(k)||Ue.test(k)||L.test(k)||V.test(k))break;if(Y.search(this.rules.other.nonSpaceChar)>=S||!k.trim())f+=`
